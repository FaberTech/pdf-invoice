...
class InvoicePrinter extends FPDF
{
    ...
    public function addItem($project_id, $project_address, $project_supervisor, $project_total, $item, $description = "", $project_name, $total_quantity, $quantity, $quantity_ot, $price, $price_ot = 0, $total, $po_number = null)
    {
        $p['item']        = $item;
